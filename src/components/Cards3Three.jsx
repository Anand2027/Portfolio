...
const Card = ({logo,kuchh,photo,Name})=>(
    ...
    <div className="bg-[#EAFFFF] shadow-3xl rounded-xl p-1 text-black w-70 text-center pt-[20px] items-centre transform transition-transform duration-300 md:80 hover:scale-95 border border-green border-solid ">
